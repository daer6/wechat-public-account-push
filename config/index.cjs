  ...
  USERS: [
    {
      ...
      id: 'oLBnL6RhzkhoEkaXoILXV2WQXEGw',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'Ic1OQ-uo3Ns3TgXmc7QiIp_ggevIHAN2K6LBsZZtbKU',
      // 所在省份
      province: '江苏',
      // 所在城市
      city: '南京',
      ...
      festivals: [
        ...
        {
          type: '*生日', name: '老婆', year: '2001', date: '12-21',
        },
        {
        ...
        {
          type: '生日', name: '臭老婆', year: '2001', date: '12-21',
        },
        {
          type: '节日', name: '被搭讪纪念日', year: '2021', date: '08-14',
        }
      ],
